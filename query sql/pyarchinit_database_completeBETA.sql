--database basato su un template postgis 2.0
-- per i database con template postgis 1.5 i create devono essere:

--CREATE TABLE gtest ( ID int4, NAME varchar(20) );
--SELECT AddGeometryColumn('', 'gtest','geom',-1,'POINT',2);
--
...
(
  ...
  us_s integer,
  the_geom geometry(MultiPolygon, 3004),
